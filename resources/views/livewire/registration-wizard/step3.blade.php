<x-glass-card class="p-6 md:p-8" :noAnimation="true">
    ...
    <div class="space-y-6">
        @if($photoPreview)
            <div class="relative">
                <img src="{{ $photoPreview }}" alt="Preview" class="w-full max-w-md mx-auto rounded-2xl shadow-lg" />
        ...
        @else
            <label for="photo-upload"
                ...
                <input id="photo-upload" type="file" accept="image/*" wire:model="photo" class="hidden" />
            </label>
        @endif
    </div>
