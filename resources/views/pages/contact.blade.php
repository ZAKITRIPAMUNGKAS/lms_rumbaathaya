...
@section('content')
    @php
        $contactInfo = [
            [
                ...
                'title' => 'WhatsApp',
                'value' => '+6282-3135-09532',
                'link' => 'https://wa.me/6282313509532',
            ...
            [
                ...
                'title' => 'Instagram',
                'value' => '@hidayah.irfan',
                'link' => 'https://instagram.com/hidayah.irfan',
    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <x-premium-hero :badge="['icon' => 'ph-phone', 'text' => 'Hubungi Kami']" title="Kontak" titleHighlight="Kami"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
                    ...
                    <div class="space-y-8">
                        <x-animated-card delay="0.1"
                            ...
                            <div class="space-y-6">
                                @foreach($contactInfo as $index => $info)
                                    <div class="flex items-start gap-4" x-data="{ loaded: true }" x-intersect="loaded = true"
                                        ...
                                        <div class="w-12 h-12 {{ $info['bgColor'] }} rounded-xl flex items-center justify-center {{ $info['iconColor'] }} flex-shrink-0"
                                            x-data="{ hovered: false }" @mouseenter="hovered = true"
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ $info['link'] }}" @if(str_starts_with($info['link'], 'http'))
                        ...
                        <!-- Social Media -->
                        <x-animated-card delay="0.2"
                            class="bg-gradient-to-br from-brand-orange/10 to-amber-50 rounded-[2rem] p-8 border border-brand-orange/20 shadow-lg shadow-orange-500/10">
                    ...
                    <div class="space-y-6">
                        <x-animated-card delay="0.3"
                            ...
                            <a href="https://wa.me/6282313509532?text=Halo,%20saya%20ingin%20daftar%20di%20Rumba%20Athaya"
                        ...
                        <x-animated-card delay="0.4"
                            ...
                            <a href="https://wa.me/6282313509532?text=Halo,%20saya%20ingin%20konsultasi%20tentang%20program%20Rumba%20Athaya"
                                target="_blank" rel="noopener noreferrer"
                        ...
                        <x-animated-card delay="0.5"
                            ...
                            <div class="space-y-3 text-gray-700">
                                @foreach($operatingHours as $index => $schedule)
                                    <div class="flex justify-between" x-data="{ loaded: true }" x-intersect="loaded = true"
                                        x-show="loaded" x-transition:enter="transition ease-out duration-300"
