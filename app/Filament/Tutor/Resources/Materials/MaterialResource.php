...
namespace App\Filament\Tutor\Resources\Materials;

use App\Filament\Tutor\Resources\Materials\Pages\ManageMaterials;
...
class MaterialResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('uploaded_by', Auth::id()) // Tutors only see their own materials
            ->select([
                'materials.id',
                'materials.title',
    ...
    {
        // Auto-set uploaded_by to current tutor
    ...
    {
        // Ensure uploaded_by is set on create (if not already set)
